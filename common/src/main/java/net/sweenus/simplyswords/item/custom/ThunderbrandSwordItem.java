...
public class ThunderbrandSwordItem extends UniqueSwordItem {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        float baseAbilityDamage = Config.getFloat("thunderBlitzDamage", "UniqueEffects", ConfigDefaultValues.thunderBlitzDamage);
        float scaling = HelperMethods.commonSpellAttributeScaling(spellScalingModifier, entity, "lightning");
